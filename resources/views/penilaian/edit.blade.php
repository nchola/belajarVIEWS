...
@section('content')
    <div class="page-breadcrumb">
        <div class="row align-items-center">
            <div class="col-md-6 col-8 align-self-center">
                <h3 class="page-title mb-0 p-0">Edit Penilaian</h3>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <form action="{{ route('penilaian.update', ['penilaian' => $penilaian->id]) }}" method="POST">
                    @method('PUT')
                    @csrf
                    <div class="card">
                        <div class="card-body">
                                ...
                                <div class="col-md-6">
                                        ...
                                        <select name="pelanggan_id" class="form-control">
                                            @foreach ($pelanggan as $item)
                                                <option value="{{ $item->id }}"
                                                    {{ old('pelanggan_id', $penilaian->pelanggan_id) == $item->id ? 'selected' : '' }}>
                                                    {{ $item->nama }}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="tahun" class="form-control">
                                            @for ($tahun = 2010; $tahun <= 2050; $tahun++)
                                                <option value="{{ $tahun }}"
                                                    {{ old('tahun', $penilaian->tahun) == $tahun ? 'selected' : '' }}>
                                                    {{ $tahun }}</option>
                                            @endfor
                                        </select>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="nilai" class="form-control"
                                            value="{{ old('nilai', $penilaian->nilai) }}" placeholder="Input Nilai...">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select name="kriteria_id" class="form-control">
                                            @foreach ($kriteria as $item)
                                                <option value="{{ $item->id }}"
                                                    {{ old('kriteria_id', $penilaian->kriteria_id) == $item->id ? 'selected' : '' }}>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="bulan" class="form-control">
                                            ...
                                            @for ($i = 1; $i <= 12; $i++)
                                                <option value="{{ $i }}"
                                                    {{ old('bulan', $penilaian->bulan) == $i ? 'selected' : '' }}>
                                                    {{ $bulan[$i - 1] }}</option>
                                            @endfor
                                        </select>
